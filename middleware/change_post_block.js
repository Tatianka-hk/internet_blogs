        ...
        if (result != null ){
            ...
            Block
                ...
                .then((result)=>{ 
                    ...
                    var block = Block({type_name:type_name, user_id:user_id,blog_name:blog_name, post_name:post_name,code:scs, date:now, id:s_id, post:true, url })   
            ...
            Block
                ...
                .then((result)=>{ 
                    var s_id= find_max(result);
                    var block = Block({type_name:type_name, user_id:user_id,blog_name:blog_name, post_name:post_name,code:scs, date:now, id:s_id, post:true})   
                    block.save().then((result)=>{}).catch((error)=>{console.log(error)});
                }).catch((error)=>{console.log(error)})
        }
    })
